...
| F-002 | backlog | Product scaffolder | One command creates a new product repo with all Layer-1 artifacts, git, a fresh GitHub repo under the factory account (`gh repo create`), branch protection. |
