...
|---|---|---|---|
| F-000 | backlog | Toolchain | Stack chosen in Define; `lint`, `typecheck`, `test` are real commands (the scaffolded placeholders fail on purpose); coverage ratchet armed. |
